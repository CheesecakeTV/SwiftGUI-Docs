...
# SwiftGUI Minesweeper
The beloved game probably implemented in any programming language.

When starting the script, you are greeted by a "launcher":\
![](../../assets/images/2026-01-21-18-10-06.png)\
Here you can set the game's parameter and start the game.

When closing the window, these values are saved to a file and restored when re-opened.

You can launch new games while a game is already open, since it is implemented as a non-blocking popup.

![](../../assets/images/2026-01-21-18-16-49.png)

Left-clicking a field "reveals" it number/bomb.\
Right-clicking adds or removes a "?" indicating there might be a bomb.\
"Flagged" fields cannot be left-clicked to avoid accidents.

# Demonstrated concepts
This is implemented with good examples for many advanced topics.
I didn't hold back and just implemented it like I would implement a "simple" minesweeper.
It sure isn't professional, but works very well.

Small warning: The code is not really suited for Python-beginners.

Demonstrated SwiftGUI concepts:
- Abstract/dynamic usage of keys
  - Non-string keys
- Key-functions
  - Destroy-events
- Procedurally generating layouts
- Non-blocking popups
- Multi-window applications
- Working with custom element-flags
- Binding events

# Full code
Using SwiftGUI version 0.11.2.
